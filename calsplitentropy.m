...
cond_prob_b_splitb1= size(find(bb1(:,1)==1),1)/(size(find(train_result_matrix(:,b_col)==1),1));
cond_prob_b_splitb2=size(find(bb1(:,1)==2),1)/(size(find(train_result_matrix(:,b_col)==1),1));

bb2=(train_result_matrix(train_result_matrix(:,b_col)==0,:));
cond_prob_b_splitb3= size(find(bb2(:,1)==1),1)/(size(find(train_result_matrix(:,b_col)==0),1));
cond_prob_b_splitb4= size(find(bb2(:,1)==2),1)/(size(find(train_result_matrix(:,b_col)==0),1));
...
size(find(train_result_matrix(:,m_col)==2),1);
size(find(train_result_matrix(:,m_col)==0),1);
prob_m1= size(find(train_result_matrix(:,m_col)==2),1)/(numbenign+nummalignant);
prob_m2= size(find(train_result_matrix(:,m_col)==0),1)/(numbenign+nummalignant);
mm1=(train_result_matrix(find(train_result_matrix(:,m_col)==2),:));

cond_prob_m_splitm1= size(find(mm1(:,1)==1),1)/(size(find(train_result_matrix(:,m_col)==2),1));
cond_prob_m_splitm2= size(find(mm1(:,1)==2),1)/(size(find(train_result_matrix(:,m_col)==2),1));
...
cond_prob_m_splitm4= size(find(mm2(:,1)==2),1)/(size(find(train_result_matrix(:,m_col)==0),1));
